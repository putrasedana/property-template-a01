...
<footer class="bg-gray-900 text-gray-300">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div class="col-span-1 md:col-span-2">
        <div class="flex items-center gap-2 mb-4">
          ...
          <span class="text-2xl font-bold text-white"
            >Premium<span class="text-primary-500">Realty</span></span
          >
        </div>
        <p class="text-gray-400 mb-4 max-w-md">
          Your trusted partner in finding the perfect property. We combine
          market expertise with personalized service to help you achieve your
          real estate goals.
        </p>
      ...
      <div>
        ...
        <ul class="space-y-2">
          <li class="flex items-start gap-2">
            ...
            <span class="text-sm"
              >123 Real Estate Ave, Suite 100<br />New York, NY 10001</span
            >
          </li>
          <li class="flex items-center gap-2">
            ...
            <span class="text-sm">info@premiumrealty.com</span>
          </li>
          <li class="flex items-center gap-2">
            <svg
              class="w-5 h-5 text-primary-500"
    ...
    >
      <p>&copy; 2024 PremiumRealty. All rights reserved.</p>
    </div>
  </div>
</footer>
